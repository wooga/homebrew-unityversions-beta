...
```bash
brew cask install unity@2020.2.0a19
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.2.0a19
```
...
`unity-android-support-for-editor@2020.2.0a19` --> `/Applications/Unity-2020.2.0a19/PlaybackEngines/`
