...
```bash
brew cask install unity@2020.2.0a16
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.2.0a16
```
...
`unity-android-support-for-editor@2020.2.0a16` --> `/Applications/Unity-2020.2.0a16/PlaybackEngines/`
