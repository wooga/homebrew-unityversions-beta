...
```bash
brew cask install unity@2019.3.0a5
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.3.0a5
```
...
`unity-android-support-for-editor@2019.3.0a5` --> `/Applications/Unity-2019.3.0a5/PlaybackEngines/`
