...
```bash
brew cask install unity@2020.2.0a21
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.2.0a21
```
...
`unity-android-support-for-editor@2020.2.0a21` --> `/Applications/Unity-2020.2.0a21/PlaybackEngines/`
