...
```bash
brew cask install unity@2019.2.0b9
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.2.0b9
```
...
`unity-android-support-for-editor@2019.2.0b9` --> `/Applications/Unity-2019.2.0b9/PlaybackEngines/`
