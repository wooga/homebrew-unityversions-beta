...
```bash
brew cask install unity@2019.3.0a7
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.3.0a7
```
...
`unity-android-support-for-editor@2019.3.0a7` --> `/Applications/Unity-2019.3.0a7/PlaybackEngines/`
