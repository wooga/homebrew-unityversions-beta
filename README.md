...
```bash
brew cask install unity@2020.1.0b10
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.1.0b10
```
...
`unity-android-support-for-editor@2020.1.0b10` --> `/Applications/Unity-2020.1.0b10/PlaybackEngines/`
