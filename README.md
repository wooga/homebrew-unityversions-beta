...
```bash
brew cask install unity@2020.1.0a14
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.1.0a14
```
...
`unity-android-support-for-editor@2020.1.0a14` --> `/Applications/Unity-2020.1.0a14/PlaybackEngines/`
