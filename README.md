...
```bash
brew cask install unity@2019.1.0b3
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.1.0b3
```
...
`unity-android-support-for-editor@2019.1.0b3` --> `/Applications/Unity-2019.1.0b3/PlaybackEngines/`
