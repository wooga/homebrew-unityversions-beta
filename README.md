...
```bash
brew cask install unity@2019.3.0f3
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.3.0f3
```
...
`unity-android-support-for-editor@2019.3.0f3` --> `/Applications/Unity-2019.3.0f3/PlaybackEngines/`
