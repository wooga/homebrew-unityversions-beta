...
```bash
brew cask install unity@2020.1.0b1
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.1.0b1
```
...
`unity-android-support-for-editor@2020.1.0b1` --> `/Applications/Unity-2020.1.0b1/PlaybackEngines/`
