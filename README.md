...
```bash
brew cask install unity@2020.1.0a15
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.1.0a15
```
...
`unity-android-support-for-editor@2020.1.0a15` --> `/Applications/Unity-2020.1.0a15/PlaybackEngines/`
