...
```bash
brew cask install unity@2020.1.0a23
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.1.0a23
```
...
`unity-android-support-for-editor@2020.1.0a23` --> `/Applications/Unity-2020.1.0a23/PlaybackEngines/`
