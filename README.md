...
```bash
brew cask install unity@2020.1.0a22
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.1.0a22
```
...
`unity-android-support-for-editor@2020.1.0a22` --> `/Applications/Unity-2020.1.0a22/PlaybackEngines/`
