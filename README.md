...
```bash
brew cask install unity@2020.1.0a18
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.1.0a18
```
...
`unity-android-support-for-editor@2020.1.0a18` --> `/Applications/Unity-2020.1.0a18/PlaybackEngines/`
