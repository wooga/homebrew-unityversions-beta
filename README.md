...
```bash
brew cask install unity@2020.1.0a3
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.1.0a3
```
...
`unity-android-support-for-editor@2020.1.0a3` --> `/Applications/Unity-2020.1.0a3/PlaybackEngines/`
