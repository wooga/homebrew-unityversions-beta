...
```bash
brew cask install unity@2019.3.0b1
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.3.0b1
```
...
`unity-android-support-for-editor@2019.3.0b1` --> `/Applications/Unity-2019.3.0b1/PlaybackEngines/`
