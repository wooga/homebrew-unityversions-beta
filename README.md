...
```bash
brew cask install unity@2019.3.0b2
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.3.0b2
```
...
`unity-android-support-for-editor@2019.3.0b2` --> `/Applications/Unity-2019.3.0b2/PlaybackEngines/`
