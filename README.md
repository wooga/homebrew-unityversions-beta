...
```bash
brew cask install unity@2020.1.0a24
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.1.0a24
```
...
`unity-android-support-for-editor@2020.1.0a24` --> `/Applications/Unity-2020.1.0a24/PlaybackEngines/`
