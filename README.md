...
```bash
brew cask install unity@2020.2.0b5
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.2.0b5
```
...
`unity-android-support-for-editor@2020.2.0b5` --> `/Applications/Unity-2020.2.0b5/PlaybackEngines/`
