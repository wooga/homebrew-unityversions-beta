...
```bash
brew cask install unity@2019.3.0a12
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.3.0a12
```
...
`unity-android-support-for-editor@2019.3.0a12` --> `/Applications/Unity-2019.3.0a12/PlaybackEngines/`
