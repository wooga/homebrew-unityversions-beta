...
```bash
brew cask install unity@2019.3.0f6
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.3.0f6
```
...
`unity-android-support-for-editor@2019.3.0f6` --> `/Applications/Unity-2019.3.0f6/PlaybackEngines/`
