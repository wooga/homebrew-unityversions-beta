...
```bash
brew cask install unity@2019.3.0a8
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.3.0a8
```
...
`unity-android-support-for-editor@2019.3.0a8` --> `/Applications/Unity-2019.3.0a8/PlaybackEngines/`
