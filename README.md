...
```bash
brew cask install unity@2020.2.0a13
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.2.0a13
```
...
`unity-android-support-for-editor@2020.2.0a13` --> `/Applications/Unity-2020.2.0a13/PlaybackEngines/`
