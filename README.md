...
```bash
brew cask install unity@2020.2.0a11
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.2.0a11
```
...
`unity-android-support-for-editor@2020.2.0a11` --> `/Applications/Unity-2020.2.0a11/PlaybackEngines/`
