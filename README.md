...
```bash
brew cask install unity@2019.3.0b8
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.3.0b8
```
...
`unity-android-support-for-editor@2019.3.0b8` --> `/Applications/Unity-2019.3.0b8/PlaybackEngines/`
