...
```bash
brew cask install unity@2018.3.0b12
```

-or-

```bash
brew cask install unity-android-support-for-editor@2018.3.0b12
```
...
`unity-android-support-for-editor@2018.3.0b12` --> `/Applications/Unity-2018.3.0b12/PlaybackEngines/`
