...
```bash
brew cask install unity@2020.1.0b12
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.1.0b12
```
...
`unity-android-support-for-editor@2020.1.0b12` --> `/Applications/Unity-2020.1.0b12/PlaybackEngines/`
