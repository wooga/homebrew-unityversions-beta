...
```bash
brew cask install unity@2019.1.0a9
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.1.0a9
```
...
`unity-android-support-for-editor@2019.1.0a9` --> `/Applications/Unity-2019.1.0a9/PlaybackEngines/`
