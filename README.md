...
```bash
brew cask install unity@2019.1.0a13
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.1.0a13
```
...
`unity-android-support-for-editor@2019.1.0a13` --> `/Applications/Unity-2019.1.0a13/PlaybackEngines/`
