...
```bash
brew cask install unity@2020.1.0a25
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.1.0a25
```
...
`unity-android-support-for-editor@2020.1.0a25` --> `/Applications/Unity-2020.1.0a25/PlaybackEngines/`
