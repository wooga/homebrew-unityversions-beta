...
```bash
brew cask install unity@2020.1.0a17
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.1.0a17
```
...
`unity-android-support-for-editor@2020.1.0a17` --> `/Applications/Unity-2020.1.0a17/PlaybackEngines/`
