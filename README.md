...
```bash
brew cask install unity@2019.2.3f1
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.2.3f1
```
...
`unity-android-support-for-editor@2019.2.3f1` --> `/Applications/Unity-2019.2.3f1/PlaybackEngines/`
