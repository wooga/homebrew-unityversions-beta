...
```bash
brew cask install unity@2019.2.0b7
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.2.0b7
```
...
`unity-android-support-for-editor@2019.2.0b7` --> `/Applications/Unity-2019.2.0b7/PlaybackEngines/`
