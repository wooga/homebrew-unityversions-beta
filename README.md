...
```bash
brew cask install unity@2020.1.0b2
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.1.0b2
```
...
`unity-android-support-for-editor@2020.1.0b2` --> `/Applications/Unity-2020.1.0b2/PlaybackEngines/`
