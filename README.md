...
```bash
brew cask install unity@2019.3.0a4
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.3.0a4
```
...
`unity-android-support-for-editor@2019.3.0a4` --> `/Applications/Unity-2019.3.0a4/PlaybackEngines/`
