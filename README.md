...
```bash
brew cask install unity@2020.1.0b13
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.1.0b13
```
...
`unity-android-support-for-editor@2020.1.0b13` --> `/Applications/Unity-2020.1.0b13/PlaybackEngines/`
