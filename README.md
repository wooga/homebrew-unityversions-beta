...
```bash
brew cask install unity@2019.3.0a10
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.3.0a10
```
...
`unity-android-support-for-editor@2019.3.0a10` --> `/Applications/Unity-2019.3.0a10/PlaybackEngines/`
