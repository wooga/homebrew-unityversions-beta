...
```bash
brew cask install unity@2020.2.0b6
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.2.0b6
```
...
`unity-android-support-for-editor@2020.2.0b6` --> `/Applications/Unity-2020.2.0b6/PlaybackEngines/`
