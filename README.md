...
```bash
brew cask install unity@2020.1.0b11
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.1.0b11
```
...
`unity-android-support-for-editor@2020.1.0b11` --> `/Applications/Unity-2020.1.0b11/PlaybackEngines/`
