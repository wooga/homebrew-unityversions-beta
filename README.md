...
```bash
brew cask install unity@2019.2.0a14
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.2.0a14
```
...
`unity-android-support-for-editor@2019.2.0a14` --> `/Applications/Unity-2019.2.0a14/PlaybackEngines/`
