...
```bash
brew cask install unity@2020.2.0a9
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.2.0a9
```
...
`unity-android-support-for-editor@2020.2.0a9` --> `/Applications/Unity-2020.2.0a9/PlaybackEngines/`
