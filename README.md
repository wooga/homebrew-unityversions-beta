...
```bash
brew cask install unity@2020.1.0b16
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.1.0b16
```
...
`unity-android-support-for-editor@2020.1.0b16` --> `/Applications/Unity-2020.1.0b16/PlaybackEngines/`
