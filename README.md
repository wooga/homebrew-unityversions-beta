...
```bash
brew cask install unity@2019.2.0a6
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.2.0a6
```
...
`unity-android-support-for-editor@2019.2.0a6` --> `/Applications/Unity-2019.2.0a6/PlaybackEngines/`
