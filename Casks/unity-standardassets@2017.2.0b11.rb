cask 'unity-standardassets@2017.2.0b11' do
  version '2017.2.0b11,614980c52f17'
  sha256 :no_check

  url "http://beta.unity3d.com/download/614980c52f17/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.2.0b11/Standard Assets'
end
