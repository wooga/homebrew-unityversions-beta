cask 'unity-ios-support-for-editor@2017.1.0b7' do
  ...
  url "http://beta.unity3d.com/download/8a1ad67dc191/MacEditorTargetInstaller/UnitySetup-iOS-Support-for-Editor-2017.1.0b7.pkg"
  name 'iOS Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-iOS-Support-for-Editor-2017.1.0b7.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.1.0b7/PlaybackEngines/iOSSupport'
end
