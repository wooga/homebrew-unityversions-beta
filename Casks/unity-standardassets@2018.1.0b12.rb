cask 'unity-standardassets@2018.1.0b12' do
  version '2018.1.0b12,b4ca90bad6b1'
  sha256 :no_check

  url "http://beta.unity3d.com/download/b4ca90bad6b1/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2018.1.0b12/Standard Assets'
end
