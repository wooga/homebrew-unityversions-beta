cask 'unity-standardassets@2017.1.0b3' do
  version '2017.1.0b3,9393889e4fe6'
  sha256 :no_check

  url "http://beta.unity3d.com/download/9393889e4fe6/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.1.0b3/Standard Assets'
end
