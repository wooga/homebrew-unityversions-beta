cask 'unity-standardassets@2017.1.0b2' do
  version '2017.1.0b2,5e138e18bf82'
  sha256 :no_check

  url "http://beta.unity3d.com/download/5e138e18bf82/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.1.0b2/Standard Assets'
end
