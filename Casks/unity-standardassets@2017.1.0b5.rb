cask 'unity-standardassets@2017.1.0b5' do
  version '2017.1.0b5,e2f219641e2c'
  sha256 :no_check

  url "http://beta.unity3d.com/download/e2f219641e2c/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.1.0b5/Standard Assets'
end
