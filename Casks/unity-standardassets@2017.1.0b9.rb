cask 'unity-standardassets@2017.1.0b9' do
  version '2017.1.0b9,a1e6a9071015'
  sha256 :no_check

  url "http://beta.unity3d.com/download/a1e6a9071015/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.1.0b9/Standard Assets'
end
