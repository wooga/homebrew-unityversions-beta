cask 'unity-ios-support-for-editor@2017.3.0b6' do
  ...
  url "http://beta.unity3d.com/download/57ec95547059/MacEditorTargetInstaller/UnitySetup-iOS-Support-for-Editor-2017.3.0b6.pkg"
  name 'iOS Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-iOS-Support-for-Editor-2017.3.0b6.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.3.0b6/PlaybackEngines/iOSSupport'
end
