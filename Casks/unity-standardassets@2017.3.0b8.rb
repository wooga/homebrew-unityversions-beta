cask 'unity-standardassets@2017.3.0b8' do
  version '2017.3.0b8,d2b3b1ff7201'
  sha256 :no_check

  url "http://beta.unity3d.com/download/d2b3b1ff7201/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.3.0b8/Standard Assets'
end
