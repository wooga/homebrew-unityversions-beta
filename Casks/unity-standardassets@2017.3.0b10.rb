cask 'unity-standardassets@2017.3.0b10' do
  version '2017.3.0b10,d1367129888f'
  sha256 :no_check

  url "http://beta.unity3d.com/download/d1367129888f/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.3.0b10/Standard Assets'
end
