cask 'unity-standardassets@2017.3.0b7' do
  version '2017.3.0b7,93b5ce6f4b0f'
  sha256 :no_check

  url "http://beta.unity3d.com/download/93b5ce6f4b0f/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.3.0b7/Standard Assets'
end
