cask 'unity-standardassets@2018.1.0b4' do
  version '2018.1.0b4,003615bcffde'
  sha256 :no_check

  url "http://beta.unity3d.com/download/003615bcffde/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2018.1.0b4/Standard Assets'
end
