cask 'unity-android-support-for-editor@2017.3.0b1' do
  ...
  url "http://beta.unity3d.com/download/bc2668834c45/MacEditorTargetInstaller/UnitySetup-Android-Support-for-Editor-2017.3.0b1.pkg"
  name 'Android Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-Android-Support-for-Editor-2017.3.0b1.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.3.0b1/PlaybackEngines/AndroidPlayer'
end
