cask 'unity-standardassets@2017.3.0b1' do
  version '2017.3.0b1,bc2668834c45'
  sha256 :no_check

  url "http://beta.unity3d.com/download/bc2668834c45/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.3.0b1/Standard Assets'
end
