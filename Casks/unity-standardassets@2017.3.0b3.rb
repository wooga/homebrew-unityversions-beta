cask 'unity-standardassets@2017.3.0b3' do
  version '2017.3.0b3,28dc7ce05bb9'
  sha256 :no_check

  url "http://beta.unity3d.com/download/28dc7ce05bb9/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.3.0b3/Standard Assets'
end
