cask 'unity-standardassets@2017.1.0b7' do
  version '2017.1.0b7,8a1ad67dc191'
  sha256 :no_check

  url "http://beta.unity3d.com/download/8a1ad67dc191/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.1.0b7/Standard Assets'
end
