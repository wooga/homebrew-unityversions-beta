cask 'unity-standardassets@2018.1.0b13' do
  version '2018.1.0b13,43de91b8ac41'
  sha256 :no_check

  url "http://beta.unity3d.com/download/43de91b8ac41/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2018.1.0b13/Standard Assets'
end
