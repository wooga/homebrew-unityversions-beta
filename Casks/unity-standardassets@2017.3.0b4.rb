cask 'unity-standardassets@2017.3.0b4' do
  version '2017.3.0b4,4c1b6e48c9c9'
  sha256 :no_check

  url "http://beta.unity3d.com/download/4c1b6e48c9c9/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.3.0b4/Standard Assets'
end
