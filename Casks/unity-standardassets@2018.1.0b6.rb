cask 'unity-standardassets@2018.1.0b6' do
  version '2018.1.0b6,2c4679632cfb'
  sha256 :no_check

  url "http://beta.unity3d.com/download/2c4679632cfb/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2018.1.0b6/Standard Assets'
end
