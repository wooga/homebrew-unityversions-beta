cask 'unity-standardassets@2017.2.0b5' do
  version '2017.2.0b5,9b4733af38e7'
  sha256 :no_check

  url "http://beta.unity3d.com/download/9b4733af38e7/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.2.0b5/Standard Assets'
end
