cask 'unity-standardassets@2017.2.0b9' do
  version '2017.2.0b9,95ec3a4d5d9d'
  sha256 :no_check

  url "http://beta.unity3d.com/download/95ec3a4d5d9d/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.2.0b9/Standard Assets'
end
