cask 'unity-standardassets@2018.1.0b2' do
  version '2018.1.0b2,79c3bdce0980'
  sha256 :no_check

  url "http://beta.unity3d.com/download/79c3bdce0980/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2018.1.0b2/Standard Assets'
end
