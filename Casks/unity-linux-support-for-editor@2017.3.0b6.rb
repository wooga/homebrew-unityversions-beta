cask 'unity-linux-support-for-editor@2017.3.0b6' do
  ...
  url "http://beta.unity3d.com/download/57ec95547059/MacEditorTargetInstaller/UnitySetup-Linux-Support-for-Editor-2017.3.0b6.pkg"
  name 'Linux Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-Linux-Support-for-Editor-2017.3.0b6.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.3.0b6/PlaybackEngines/LinuxStandaloneSupport'
end
