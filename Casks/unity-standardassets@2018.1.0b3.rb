cask 'unity-standardassets@2018.1.0b3' do
  version '2018.1.0b3,e1ef60e69006'
  sha256 :no_check

  url "http://beta.unity3d.com/download/e1ef60e69006/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2018.1.0b3/Standard Assets'
end
