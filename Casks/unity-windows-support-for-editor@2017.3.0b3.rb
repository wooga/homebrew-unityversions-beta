cask 'unity-windows-support-for-editor@2017.3.0b3' do
  ...
  url "http://beta.unity3d.com/download/28dc7ce05bb9/MacEditorTargetInstaller/UnitySetup-Windows-Support-for-Editor-2017.3.0b3.pkg"
  name 'Windows Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-Windows-Support-for-Editor-2017.3.0b3.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.3.0b3/PlaybackEngines/WindowsStandaloneSupport'
end
