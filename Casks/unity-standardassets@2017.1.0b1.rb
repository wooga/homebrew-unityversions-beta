cask 'unity-standardassets@2017.1.0b1' do
  version '2017.1.0b1,a29fc4a7eb25'
  sha256 :no_check

  url "http://beta.unity3d.com/download/a29fc4a7eb25/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.1.0b1/Standard Assets'
end
