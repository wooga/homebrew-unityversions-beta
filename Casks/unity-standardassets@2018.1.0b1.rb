cask 'unity-standardassets@2018.1.0b1' do
  version '2018.1.0b1,bcd94551ef32'
  sha256 :no_check

  url "http://beta.unity3d.com/download/bcd94551ef32/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2018.1.0b1/Standard Assets'
end
